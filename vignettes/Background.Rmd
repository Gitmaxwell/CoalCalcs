...
Coal moisture and insitu density conversions are among the most common conversion in the coal industry. These conversions allow for the comparison of coal constitutes (such as ash, volatile matter, fixed carbon) on a common basis. Further, reporting of coal at insitu density basis is a requirement for the reporting of coal resources and reserves (@code2012jorc). As such numerous studies (@C10041, @C10042) have been undertaken to derive formulas for calculating insitu moisture and density. While these formulas and conversions are relatively accessible in the literature, these formulas have not been conveniently wrapped in any open source software package/program. CoalCalcs hopes to bridge this gap.
...
Procedures for these equations are presented in section 5 (of ACARP report C10041) and consist of:
...
Refered to in CoalCalcs as method M1A, and M1B respective
